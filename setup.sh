...
echo ""
echo -e "${CYAN}  Before your first release build:${RESET}"
echo "  macOS requires Automation permission to configure the DMG window."
echo "  System Settings → Privacy & Security → Automation"
echo "  → enable your terminal (or IDE) to control Finder"
echo "  If the build fails with 'error running bundle_dmg.sh', this permission"
echo "  is likely missing for whichever app launched the build."
echo "  To see the underlying error: RUST_LOG=tauri_bundler=debug npm run tauri build"
